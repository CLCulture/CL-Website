...
The overall objective for the group is to relax, hang out, and make friends using the Anime and Video Game Focus.
    ...
    <ol class="white-text">
      ...
      <li>Please try to keep discussions PG-13 or lower outside of the NSFW-designated rooms.</li>
      <li>Please refrain from posting any NSFW(18+) content outside of the designated channels. Thank You!</li>
      <li>Drama/Spam/"Being Cancerous"/disrupting the ecosystem of this server is forbidden. If you are causing issues with people you are not acquainted/familiar with are are asked to stop, please stop what you're doing when and if someone tells you to stop. We are a drama-free server. Posting random text such as “vkjadvbvfjvbhdf” and emotes/emojis that contribute nothing and falls under spamming offenses.
</li>
